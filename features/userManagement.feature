Feature: User management feature
  ...
  Scenario: A customer request to be register
    ...
    And the customers first name is "John"
    And the customers last name is "Doe"
    And the customers CPR number "12345678"
...
#    And the account balance is 300 kr
  ...
  Scenario: merchant create bank account
    ...
    And the merchants first name is "Johan"
    And the merchants last name is "Bob"
    And the merchants CPR number "100283-0013"
